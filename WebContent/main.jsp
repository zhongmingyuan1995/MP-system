                ...
                <li class="am-dropdown" data-am-dropdown data-am-dropdown-toggle>
                    ...
                    <ul class="am-dropdown-content tpl-dropdown-content">
                      ...
                      <span class="tpl-dropdown-content-from"> 禁言小张 </span>
                                ...
                                <span class="tpl-dropdown-content-font">江中医保处方系统 </span>
                            </a>
                            <a href="#" class="tpl-dropdown-content-message">
                                <span class="tpl-dropdown-content-photo">
        ...
        <div class="tpl-content-wrapper">
            ...
            <div class="tpl-content-scope">
                <div class="note note-info">
                    ...
                    <p> 江中医保处方系统 含近 20 个 CSS 组件、20 余 JS 组件，更有多个包含不同主题的 Web 组件，可快速构建界面出色、体验优秀的跨屏页面，大幅提升开发效率。</p>
                    <p><span class="label label-danger">提示:</span> 江中医保处方系统 关注中文排版，根据用户代理调整字体，实现更好的中文排版效果。
                    </p>
                </div>
            </div>
            ...
            <div class="row">
                <div class="am-u-lg-3 am-u-md-6 am-u-sm-12">
                    <div class="dashboard-stat blue">
                        ...
                        <div class="details">
                            <div class="number"> 门诊人数 ：150 </div>
                            <div class="desc"> 今日就诊概况</div>
                        </div>
